                ...
                <form>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Birthday Month</label>
                            <select class="form-control" name="month">
                                ...
                                <?php
                                    for($x = 1; $x <= 12; $x++){
                                        ...
                                        echo "<option ".$select." value='".sprintf("%02d", $x)."'>".date('F', strtotime("2020-".$x."-01"))."</option>";
                                    }
                                ?>
                            </select>
                        </div>
...
<div class="row">
    <div class="col-md-12">
        <a href="<?php echo base_url('report?r=employee-birthday'.$search);?>" class="btn btn-primary pull-right">PDF</a>
    </div>
</div>
